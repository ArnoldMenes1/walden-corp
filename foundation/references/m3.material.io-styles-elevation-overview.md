...
- [Differences from M2](#differences-from-m2)
- [All surfaces and components have elevation values](#all-surfaces-and-components-have-elevation-values)
  - [Resting elevation (default)](#resting-elevation-default)
...
Elevation represents the distance between elements. The product applies color to represent elevation. One surface at 1dp elevation and another surface at 8dp elevation, as viewed from the front The difference in elevation between the two surfaces is 7dp, as viewed from the side
...
<a href="https://m3.material.io/" data-_ngcontent-esx-c29="" data-mioanalyticstracking="" data-analyticslabel="/">material_design</a>
